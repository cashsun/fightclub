...
ALTER TABLE TASK CHANGE ts tstamp TIMESTAMP;
ALTER TABLE TASK ADD lastupdate TIMESTAMP;
ALTER TABLE EXP CHANGE ts tstamp TIMESTAMP;
ALTER TABLE T_GROUP CHANGE ts tstamp TIMESTAMP;
